> **SUPERSEDED for video 09 (2026-09-05):** the look is now Tymek's Claude Design system (see `lib/house.css` tokens and BRIEF.md › Design system). Keep this file for the motion timings and the seven-marks grammar; colours/type below are historical.
...
# Full grammar, motion timings and structural rules: `DESIGN-SYSTEM.md` (this project root) (read it first).
#
...
## Read this first
`DESIGN-SYSTEM.md` (this project root) is the normative spec. This file is only its token sheet.
